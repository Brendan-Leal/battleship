...
const Human = require("./humanLogic/human-class");
const Computer = require("./computerLogic/computer-class");
...
class BattleShipGame {
  ...
  play() {
    ...
    this.computer.map.display();
    this.computer.map.displayProbabilityDensity();

    // this.human.map.display(false)
    // this.human.map.display();

    // this.computer.fire();
    // this.human.reportStatus();
    // this.human.fire();
    // this.computer.reportStatus();
